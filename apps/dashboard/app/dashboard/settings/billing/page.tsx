    ...
    <div>
      ...
      <section className="rounded-xl border border-[color:var(--bg-border)] bg-[color:var(--bg-surface)] p-6">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <button
            className="inline-flex cursor-not-allowed items-center rounded-md border border-[color:var(--bg-border)] px-4 py-2 text-sm font-semibold text-[color:var(--text-tertiary)] opacity-70"
            disabled
            type="button"
          >
            Manage billing
