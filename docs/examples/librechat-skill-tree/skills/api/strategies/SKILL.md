...
# Api Strategies Skill

## Overview
Api guidance for the `strategies` surface and its closely related implementation seams.

## Check These Paths First
- {{project_root}}/api/strategies/appleStrategy.js
- {{project_root}}/api/strategies/appleStrategy.test.js
- {{project_root}}/api/strategies/discordStrategy.js
- {{project_root}}/api/strategies/facebookStrategy.js

## Patterns
### Inferred child domain patterns
- api surface: strategies
...
- Domain path: `api/api-strategies`
