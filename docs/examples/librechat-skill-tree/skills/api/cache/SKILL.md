...
## Overview
Api guidance for the `cache` surface and its closely related implementation seams.

## Check These Paths First
- {{project_root}}/api/cache/banViolation.js
- {{project_root}}/api/cache/banViolation.spec.js
- {{project_root}}/api/cache/clearPendingReq.js
- {{project_root}}/api/cache/getLogStores.js
