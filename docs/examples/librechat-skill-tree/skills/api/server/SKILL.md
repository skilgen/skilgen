...
## Overview
Api guidance for the `server` surface and its closely related implementation seams.

## Check These Paths First
- {{project_root}}/api/server/cleanup.js
- {{project_root}}/api/server/controllers/AuthController.js
- {{project_root}}/api/server/controllers/AuthController.spec.js
- {{project_root}}/api/server/controllers/Balance.js
