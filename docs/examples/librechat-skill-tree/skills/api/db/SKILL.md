...
## Overview
Api guidance for the `db` surface and its closely related implementation seams.

## Check These Paths First
- {{project_root}}/api/db/connect.js
- {{project_root}}/api/db/index.js
- {{project_root}}/api/db/index.spec.js
- {{project_root}}/api/db/indexSync.js
