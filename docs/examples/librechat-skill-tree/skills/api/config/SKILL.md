...
## Overview
Api guidance for the `config` surface and its closely related implementation seams.

## Check These Paths First
- {{project_root}}/api/config/index.js
- {{project_root}}/api/config/meiliLogger.js
- {{project_root}}/api/config/parsers.js
- {{project_root}}/api/config/paths.js
