...
# Config Translations Skill

## Overview
Config guidance for the `translations` surface and its closely related implementation seams.

## Check These Paths First
- {{project_root}}/config/translations/anthropic.ts
- {{project_root}}/config/translations/comparisons.ts
- {{project_root}}/config/translations/embeddings.ts
- {{project_root}}/config/translations/file.ts

## Patterns
### Inferred child domain patterns
- config surface: translations
...
- Domain path: `config/config-translations`
