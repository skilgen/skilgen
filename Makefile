...
verify-enterprise:
	...
	python -m unittest tests.test_openai_compliance_sync tests.test_anthropic_compliance_sync tests.test_agent_runs_smoke tests.test_skillayer_agent_cli tests.test_codex_cli_runtime tests.test_cursor_importer tests.test_cursor_fixture_capture tests.test_windsurf_importer tests.test_import_codex_sessions -v
