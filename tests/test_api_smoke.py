        ...
        with TemporaryDirectory() as tmp:
            ...
            with mock.patch.dict(os.environ, env, clear=False):
                ...
                try:
                    ...
                    self.assertIn("symbol_relationships", analysis["evidence_graph"])
                    self.assertIn("runtime_signals", analysis["evidence_graph"])
                    self.assertIn("dependency_risk_graph", analysis["evidence_graph"])
                    ...
                    self.assertIn("symbol_relationships", architecture["graph_export"]["json"])
                    self.assertIn("runtime_signals", architecture["graph_export"]["json"])
                    self.assertIn("dependency_risk_graph", architecture["graph_export"]["json"])
